...
# https://github.com/icycore/yapi/tree/fix-v1.12.0-postmanLib-frontend-build-error
# RUN git clone \
#   --branch "fix-v1.12.0-postmanLib-frontend-build-error" \
#   --single-branch \
#   --depth 1 \
#   https://github.com/icycore/yapi.git .
